package com.hd.hyd_36hr_news.news.entity;

import com.hd.hyd_36hr_news.utils.ImageUtils;
import com.hd.hyd_36hr_news.utils.TextUtils;
...
public class ArticleBean {
    ...
    public static List<ArticleBean> getArticleBeans(Document doc){
        ...
        for (int i = topSize;i<elements.size();i++) {
            ...
            String tId = TextUtils.getArticleId(href);
            href = TextUtils.getArticleHref(href);
            ...
            String author_href = TextUtils.getArticleHref(link.attr("href"));
